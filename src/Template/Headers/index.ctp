    ...
    <div class="list_item">
        ...
        <?= $this->Html->image($header->my_img) ?>
                ...
                <div class="container_title" style="color: <?= $header['my_color'] ?>;">
                        <h1 class="font_blue">   <?= $header['my_title']?></h1>
                
                
                <div class="container_about">
                    <p style="color: <?= $header['my_color'] ?>;">Avec zO Gravity, descouvrela simplicité et la performance d'une gestion de projet collaborative.</p>
                </div>
                <div class="container_button">
                     <a href="" style="color: <?= $header['my_color'] ?>;">Descouvrez zO Gravity</a>
                </div>
                <div class="container_item">
                    <i class="fa-solid fa-circle-play"></i><div class="item_vd"><p style="color: <?= $header['my_color'] ?>;">voir la vidéo</p></div>
                </div>
            </div>
