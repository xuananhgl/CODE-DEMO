            ...
            <?= $this->Html->image($header->my_img) ?>
                ...
                <div class="slider_content">
                    <div class="slider_titel"><p><?= __('PRESSE') ?></p>
                        ...
                        <div class="slider_h1"><h1><?= $data['my_title']?></h1></div>
                        <div class="slider_about"><?= $data['about']?></div>
                        <div class="slider_note">
                            <div class="note"><a href="<?= $data['link_not']?>"><?= __('Stéphane Touchet<br><a>PMO service client Orange Sud-Ouest') ?></a></div> 
